import { assertThrows, assertEquals } from "https://deno.land/std@0.133.0/testing/asserts.ts";
...
// Deno.test("Finish date shouldn't be setted before start date", function () {
//   const todo = new Todo()
//   assertThrows(
//     () => todo.setFinishDate(new Date()),
//     TodoError,
//     "Finish date should be setted after start date"
//   )
// })